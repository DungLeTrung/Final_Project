    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 30vw; max-width: none">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex">
                    <div class="col-12">
                        <form id="createForm" method="POST" action="{{ route('tour-service.execute') }}">
                            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('.editBtn').on('click', function() {
            ...
            $('#createModalLabel').text('Edit Tour Service');
            $('#createTourService').modal('show');
        });
