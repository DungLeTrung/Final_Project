...
@section('auth-content')
    ...
    <div class="container flex flex-col col-12 component-booking-hotel mt-5">
        <div class="row justify-content-center booking-hotel-component">
            <div class="col-10 d-flex booking-hotel">
                <div class="row col-12 p-0 mb-3" style="font-size: 1.25rem">
                        ...
                        <div class="search-overlay col-12 d-flex">
                            <div class="col-12">
                                <div class="p-4 search-section">
                                    <strong style="font-size: 1.75rem">TownePlace Suites Gaithersburg by Marriott</strong>
                                    <hr />
                                    ...
                                    <div class="input-style mb-3">
                                        <div class="d-flex w-100 justify-content-between align-items-center p-3">
                                            <label for="room" class="form-label"><strong style="color: #ff6f3c">1 x</strong> Standard Room</label>
                                            <p class="form-label">$120.00</p>
                                        </div>
                                    </div>
                                    <div class="input-style mb-3">
                                        <label for="promo_code" class="form-label">Add ons</label>
                                        <div class="d-flex justify-content-between align-items-center gap-3 col-12 p-0">
                                            <div class="d-flex w-100 justify-content-between align-items-center p-3">
                                                <label for="room" class="form-label">Breakfast</label>
                                                <p class="form-label">$20.00</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="input-style mb-3">
                    ...
                    <div class="col-12 col-md-8 order-3 order-md-1">
                        ...
                        <div class="col-12 mt-5 p-0">
                            <div class="mt-5">
                                @include('component-tour.booking-hotel')
                            </div>
                        </div>
                    </div>
                </div>
