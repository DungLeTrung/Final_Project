    ...
    <div class="full-width-container">
        <div class="row w-100 m-0 p-0">
            <div class="col-12 position-relative p-0">
                <img src="{{ asset('images/thumbnail_image_2.png') }}" alt="BUMYAYA" class="thumbnail_image img-fluid w-100">
                <div class="text-overlay-home-page text-left col-5">
        ...
        <div class="container flex flex-col col-12 my-5">
            <div class="travel-component container d-flex flex-column align-items-center py-5 col-md-10">
                <div class="row w-100">
                    <div class="images-section d-flex col-12 justify-content-center">
        ...
        <div class="container flex flex-col col-12 my-5">
            <div class="travel-component container d-flex flex-column align-items-center py-5 col-md-10">
                ...
                <div class="row w-100 justify-content-center">
                    <div class="text-section col-md-6 text-center">
                        <div class="quote-section mt-3 d-flex justify-content-center">
                            <div class="quote-icon me-3">
                                <span>❝</span>
                            </div>
                        ...
                        <div class="images-section col-md-12 d-none d-md-block">
